...
namespace Phayne\Saml\Provider\EntitiesDescriptor;
...
/**
 * Class FileEntitiesDescriptorProvider
 *
 * @package Phayne\Saml\Provider\EntitiesDescriptor
 */
class FileEntitiesDescriptorProvider implements EntitiesDescriptorProviderInterface
{
    ...
    public function get(): EntitiesDescriptor
    {
        if (null === $this->entitiesDescriptor) {
            ...
            $this->entitiesDescriptor->deserialize(
