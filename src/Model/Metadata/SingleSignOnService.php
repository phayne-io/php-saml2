...
class SingleSignOnService extends Endpoint
{
    ...
    {
        $element = $this->createElement('SingleSignOnService', SamlConstant::NS_METADATA, $parent, $context);
    ...
    {
        $this->checkXmlNodeName($node, 'SingleSignOnService', SamlConstant::NS_METADATA);
