...
class SingleLogoutService extends Endpoint
{
    ...
    {
        $element = $this->createElement('SingleLogoutService', SamlConstant::NS_METADATA, $parent, $context);
    ...
    {
        $this->checkXmlNodeName($node, 'SingleLogoutService', SamlConstant::NS_METADATA);
